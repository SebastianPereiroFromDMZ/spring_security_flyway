package ru.kuzmin.webfluxsecurity.errorhandling;
...
//обработчик ошибок который перехватывает все ошибки который у нас есть и вызывает метод getErrorAttributes, в этом методе (он у нас переопределен в классе AppErrorAttributes) мы в зависимости от типа ошибки указываем различные параметры
@Component
